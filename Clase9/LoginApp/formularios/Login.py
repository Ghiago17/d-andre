...
class Login(tk.Tk):
    ...
    def __init__(self):
        ...
        self.logo = utl.leer_imagen(r"C:\Users\Biblioteca\Desktop\PROGIITECNAR\Clase9\LoginApp\imagenes\logo.png", (300, 100))
        self.user = utl.leer_imagen(r"C:\Users\Biblioteca\Desktop\PROGIITECNAR\Clase9\LoginApp\imagenes\login.png", (64, 64))
    ...
    def validar(self):
        with open(r"C:\Users\Biblioteca\Desktop\PROGIITECNAR\Clase9\LoginApp\db_users.json", "r", encoding='utf-8') as file:
