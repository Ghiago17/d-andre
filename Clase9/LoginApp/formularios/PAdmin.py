...
class PAdmin(tk.Tk):
    def __init__(self, name="", username="", email=""):
        ...
        self.usrimg = utl.leer_imagen(r"C:\Users\Biblioteca\Desktop\PROGIITECNAR\Clase9\LoginApp\imagenes\userinfo.png", (128, 128))
        self.imgfacebook = utl.leer_imagen(r"C:\Users\Biblioteca\Desktop\PROGIITECNAR\Clase9\LoginApp\imagenes\face.png", (32, 32))
        self.imglinkedin = utl.leer_imagen(r"C:\Users\Biblioteca\Desktop\PROGIITECNAR\Clase9\LoginApp\imagenes\linkedin.png", (32, 32))
        self.imgwebsite = utl.leer_imagen(r"C:\Users\Biblioteca\Desktop\PROGIITECNAR\Clase9\LoginApp\imagenes\website.png", (32, 32))
        self.imglogout = utl.leer_imagen(r"C:\Users\Biblioteca\Desktop\PROGIITECNAR\Clase9\LoginApp\imagenes\logout.png", (32, 32))
    ...
    def listar_usuarios(self):
        ...
        with open(r"C:\Users\Biblioteca\Desktop\PROGIITECNAR\Clase9\LoginApp\db_users.json", "r", encoding='utf-8') as self.file:
                        ...
                        if self.tipo_action == "Actualizar":
                            ...
                            for usuarios in self.db_users["users"]:
                                if usuarios["id"] == self.tablausuarios.item(self.tablausuarios.selection())["text"]:
                                    ...
                                    with open(r'C:\Users\Biblioteca\Desktop\PROGIITECNAR\Clase9\LoginApp\db_users.json', 'w') as jf: 
